...
export default function Candidato(props) {
    function clickDetalhar() {
        props.setDetalharCandidato(true);
        props.setCandidatoSelecionado(props.candidato);
    }

    function curtida(candidato) {
        props.setListaCandidatos(props.listaCandidatos.map((candidato2) => {
            var meuCandidato = candidato2
            if (candidato2.id === candidato.id) {
                meuCandidato.curtidas++;
            }
            return meuCandidato
        }
        ))
    ...
    function descurtida(candidato) {
        props.setListaCandidatos(props.listaCandidatos.map((candidato2) => {
            var meuCandidato = candidato2
            if (candidato2.id === candidato.id) {
                meuCandidato.descurtidas++;
            }
            return meuCandidato
        }
        ))
    ...
    return (
        <Card style={{ width: '18rem' }}>
            ...
            <Card.Body>
                ...
                </Button> <Button variant="primary" onClick={() => {descurtida(props.candidato)}}> {//Não Curtir
                                           }
                ...
                <Button onClick={clickDetalhar} className="mt-1" variant="success">Conheça minhas propostas</Button>
            </Card.Body>
        </Card>
    );
}